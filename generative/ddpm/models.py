"""
contributed by : https://github.com/labmlai/annotated_deep_learning_paper_implementations/blob/master/labml_nn/diffusion/ddpm/unet.py
---
...
if __name__ == "__main__":
    ...
    i_1 = torch.rand((10, 3, imsize, imsize)).cuda()
    i_2 = torch.randint(1, 100, (10,), dtype=torch.float32).cuda()
    y = model(i_1, i_2)
