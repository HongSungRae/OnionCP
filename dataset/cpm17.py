...
class CPM17(Dataset):
    def __init__(self, dataset_path=dataset_path['cpm17'], imsize=512, split='train', gen_augmentation=None, conven_augmentation=False, p=(0.5,0.5), diffusion=False, alpha_bar=None, T=None):
